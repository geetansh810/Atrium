...
**V2 (Phase 2):** channels/messages/announcements (live since V7, M2.5 — see [[communication]]), agent_stats_daily (live since V6), ~~office_layout~~ (dropped — office track retired 2026-07-15, never applied). **V3 (Phase 3):** RLS policies, billing_accounts.
