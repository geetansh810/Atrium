...
## Services
- [[web-dashboard]] — React dashboard, mid-redesign into an "AI Operating System" (MF-1–5 done: router + new shell + primitives + real Mission Control + Tasks kanban/drawer/review inbox + Employees/profile/Organization + Projects/Knowledge/Workflow/Reports; MF-6 pending). ON REAL API, mocks still available behind `VITE_USE_MOCKS=1`
