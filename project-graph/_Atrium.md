...
## Services
- [[web-dashboard]] — React dashboard, mid-redesign into an "AI Operating System" (MF-1 done: router + new shell live; MF-2–6 pending). ON REAL API, mocks still available behind `VITE_USE_MOCKS=1`
