...
## Services
- [[web-dashboard]] — React dashboard, mid-redesign into an "AI Operating System" (MF-1–2 done: router + new shell + primitives + real Mission Control; MF-3–6 pending). ON REAL API, mocks still available behind `VITE_USE_MOCKS=1`
